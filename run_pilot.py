...
PILOT_PHOTOS: list[dict] = [
    # Solo portraits
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/許雲陽相簿/許天催01.JPG",
        "category": "solo",
        "expected_faces": 1,
        "persons": ["許天催"],
        "notes": "許天催寫字照",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/許雲陽相簿/許天催.JPG",
        "category": "solo",
        "expected_faces": 1,
        "persons": ["許天催"],
        "notes": "許天催正式坐像",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/家族照片/img110-2.jpg",
        "category": "solo",
        "expected_faces": 1,
        "persons": ["許天象"],
        "notes": "許天象青年照",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 3/家族照片/img114.jpg",
        "category": "solo",
        "expected_faces": 1,
        "persons": ["許黃秀鸞"],
        "notes": "許黃秀鸞獨照",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/許雲陽相簿/雜集_170704_0030.jpg",
        "category": "solo",
        "expected_faces": 1,
        "persons": ["許天德"],
        "notes": "許天德晚年照",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 3/家族照片/許瑞益提供/img102.jpg",
        "category": "small",
        "expected_faces": 3,
        "persons": ["許林月", "許天德", "許清貴"],
        "notes": "三人合照",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/許天德相簿/img038-2.jpg",
        "category": "small",
        "expected_faces": None,
        "persons": ["許天德"],
        "notes": "許天德一家玉山",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 3/家族照片/img056.jpg",
        "category": "small",
        "expected_faces": 3,
        "persons": ["許美崙", "許雲陽"],
        "notes": "許美崙許雲陽許瑞庭",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/許雲從相簿/img242-2.jpg",
        "category": "small",
        "expected_faces": None,
        "persons": ["許雲從"],
        "notes": "許雲從相簿",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/許天德相簿/339268680_1264127971183434_3491091249132137092_n.jpg",
        "category": "small",
        "expected_faces": 2,
        "persons": ["頭山秀三", "許天德"],
        "notes": "頭山秀三與許天德合影",
    ...
    # Medium groups (6-15)
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅/許雲陽相簿/外埔許家成員-7.jpg",
        "category": "medium",
        "expected_faces": None,
        "persons": ["許天德"],
        "notes": "許天德父子與頭山滿家族合影",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅 2/雜/1614332_10152129822748618_924157627_o.jpg",
        "category": "medium",
        "expected_faces": None,
        "persons": ["許天催", "許天象", "許雲陽"],
        "notes": "許天催許天象許雲陽等",
    ...
    # Large groups (16+)
    {
        "path": "鐵山誌圖文創作/冊二素材/戰爭尾聲/許天象 昭和18年6月10日 全家福.jpg",
        "category": "large",
        "expected_faces": 20,
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅/許雲陽相簿/外埔許家家族結婚照.jpg",
        "category": "large",
        "expected_faces": None,
        "persons": ["許天奎"],
        "notes": "許天奎林獻堂吳淮水同框",
    ...
    {
        "path": "鐵山老照片from大舅舅/鐵山老照片from 大舅舅/許雲陽相簿/img029.jpg",
        "category": "large",
        "expected_faces": None,
        "persons": [],
    ...
    {
        "path": "鐵山誌圖文創作/冊二素材/戰爭尾聲/1943年臺中州產業組合幹部鍊成會合影.jpg",
        "category": "large",
        "expected_faces": None,
        "persons": [],
